...
extism call target/wasm32-unknown-unknown/debug/wasm_bls.wasm signData --input "{\"seed\": \"B80C035591824036CC214F76B8A8A9A4D1DB1B0BADE6B6964660069D142A600A\",\"data\": \"hello\"}"
...
extism call target/wasm32-unknown-unknown/debug/wasm_bls.wasm signData --input "{ \"seed\": \"1D31933538B1CD8918BFF857BDD57AF80472D5B9C984D057FA9D0247FDEF2F08\", \"data\": \"hello\"}" --log-level=info
